...
def sequence_generator(data, batch_size, seq_len, input_shape, num_classes):
    '''
...
def image_generator(data_list, batch_size, seq_len, img_size, num_classes):
    '''
    ...
    video_gen = sequence_generator(data_list, batch_size, seq_len, img_size, num_classes)
